...
public class SmartphoneListAdapter extends BaseAdapter {
    ...
    ArrayList<SmartBeans> bean;
//    Typeface fonts1, fonts2;


    public SmartphoneListAdapter(Context context, ArrayList<SmartBeans> bean) {
        this.bean = bean;
...
//                "fonts/Lato-Regular.ttf");
        ...
        SmartphoneListAdapter.ViewHolder viewHolder = null;

        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) context.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.product_gridview, null);

            viewHolder = new SmartphoneListAdapter.ViewHolder();
            ...
            viewHolder = (SmartphoneListAdapter.ViewHolder) convertView.getTag();
        }


        SmartBeans bean = (SmartBeans) getItem(position);
