...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public Object getChild(int groupPosition, int childPosititon) {
        return this._listDataChild.get(String.valueOf(this._listDataHeader.get(groupPosition).getName()))
                .get(childPosititon);
    }
...
//        String headerTitle = (String) getGroup(groupPosition);
        ...
        if(isExpanded) {
            ...
            arrow.setBackgroundResource(R.drawable.minus);
         ...
         //  arrow.setImageResource(R.drawable.ic_up_arrow);
            arrow.setBackgroundResource(R.drawable.plus);
       ...
       // lblListHeader.setText(headerTitle);
        ...
        example.saadat.com.ewlmerge.Model.parent rowItem = (example.saadat.com.ewlmerge.Model.parent) getGroup(groupPosition);
